...
<div class="col-md-12 show_case_studies_list">
	<a href="http://oneco.ca/~dinoflex/Color_innovator/manage_home/manage_case_studies/" id="view_case_studies" target="_blank"><button type="button" name="view_case_studies">View Case Studies</button></a>
</div>
