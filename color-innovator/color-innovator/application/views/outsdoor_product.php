       ...
       <?php $i = 1;
		...
		?>  
        	 <div class='col-md-4 product_img_div'>
                <a href="<?php echo base_url();?>front_end/products/<?php echo $p['product_url'];?>"><img class="img_border img-responsive" title="<?php echo $p['product_name'];?>" src="<?php echo base_url(); ?>admin_assets/frontend/include/Image.jpg" alt="<?php echo $p['product_name'];?>"></a>
            </div>
                    	...
                    	<div class="hover_div section1">
                            ...
                            <div class="btn_skewx">
                                <div class="text-skewx">
                                    <!--<a class="sample_request">discover</a>-->
