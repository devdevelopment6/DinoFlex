...
<div class="widget-box ui-sortable-handle" id="widget-box-1">
	...
	<div class="widget-body">
		<div class="widget-main">
			<div id="page-wrapper">
				<form class="form-horizontal" id="add_news" action="<?php echo base_url(); ?>manage_home/add_location_content/" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-8">
					...
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<button type="submit" class="btn-yellow btn" name="update">Add Location Content</button>																																 				&nbsp;&nbsp; <a href="<?php echo base_url();?>manage_home/manage_products" class="btn-yellow btn" />Cancel</a>
						</div>
					</div>
				</form>
			</div>
