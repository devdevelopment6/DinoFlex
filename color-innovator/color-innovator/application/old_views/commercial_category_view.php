...
<div class="container-fluid banner product product_category_page_banner" style="padding:0px;position:relative;">
	<img src="<?php echo base_url();?>uploads/commercial_category_image/<?php echo $commercial['banner_image'];?>" class="cust_banner_prod_cat" alt="commercial_category_banner_image" style="width:100%;height:auto;">
	<div class="container">
		<div class="banner_product">
			<div class="background_small_image"></div>
			<div class="banner_txt col-sm-12">
				<div class="bg_small_img"></div>
				<h2 class="page_title hosp_title"><span><?php echo $commercial['header_title'];?></span></h2>
				<div class="row cust_container1">
					<p class="col-md-12 common_class"><?php echo  $commercial['header_content'];?></p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="img_section">
				<img src="<?php echo base_url();?>uploads/commercial_category_image/<?php echo $commercial['section_image'];?>" class="cust_product_img" alt="commercial_category_section_image" style="width:100%;height:auto;" />
			</div>
		</div>

		<div class="col-md-8 cust_container3">

			<h4 class="common_class cust_size"><span><?php echo $commercial['section_title'];?></span></h4>
			<p class="col-md-12 common_class"><span><?php echo $commercial['section_content'];?></span></p>
		</div>
...
<div class="container-fluid banner product product_category_page_banner" style="padding:0px;position:relative;">
	<img src="<?php echo base_url();?>homepage_assests/banner/dinoflex-about-02.jpg" style="width:100%;height:auto;" alt="commercial_category_application_area" class="cust_container4">
	<div class="container">
		<div class="row">
