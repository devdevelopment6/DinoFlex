...
<div class="widget-box ui-sortable-handle" id="widget-box-1">
	<div class="widget-header">
		<h5 class="widget-title">Case Study Content List</h5>
		...
		<div class="col-md-12">
			<table id="news" class="table">
				...
				<tr>
					...
					<th>Section Title1</th>
					<th>Section Content1</th>
					<th>Status</th>
					<th>Action</th>
				</tr>
				</thead>
...
<script type="text/javascript">
	...
	function getTable()
	{
		table = $('#news').dataTable({
			...
			"aaSorting": [[ 0, "desc" ]],
			"sAjaxSource": "<?php echo base_url(); ?>manage_home/get_case_studycontent/",
