...
<div class="widget-box ui-sortable-handle" id="widget-box-1">
  ...
  <div class="widget-body">
    <div class="widget-main">
      <div id="page-wrapper">
        <form class="form-horizontal" id="add_news" action="<?php echo base_url(); ?>manage_home/add_header_content/" method="post" enctype="multipart/form-data">
       																																		
          <div class="form-group">
            <label for="news_title" class="col-sm-3 control-label"> Header Content Title : </label>
            <div class="col-sm-8">
              <input class="col-sm-8" type="text" id="header_title" name="header_title" placeholder="Header Content Title"/>
            </div>
          </div>
          ...
          <div class="form-group">
                ...
                <div class="col-sm-8">
                    <textarea rows="8" id="header_short_content" name="header_short_content" class="form-control1"></textarea>
                </div>
			</div>
          ...
          <div class="form-group">
            <div class="col-sm-8 col-sm-offset-2">
              <button type="submit" class="btn-yellow btn" name="update">Add Content</button>																																 				&nbsp;&nbsp; <a href="<?php echo base_url();?>manage_home/manage_header" class="btn-yellow btn" />Cancel</a>
            </div>
          </div>
        </form>
      </div>
