...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/png" href="<?php echo base_url(); ?>home_assets/images/favicon.png"/>
				...
				<div class="custheadleft col-md-9 col-lg-9 col-sm-12 col-xs-12 ">
					<span class="col-md-2 col-lg-2 col-sm-3 col-xs-3 custnopadding">
						<a href="<?php echo base_url(); ?>" title="Innovator">
						  <img class="logo" src="<?php echo base_url(); ?>home_assets/images/color-innovator-animated.svg" alt="">
						</a>
					</span>
					<span class="col-md-8 col-lg-8 col-sm-9 col-xs-9  custnopadding list_menu">					
						<ul class="articlesmain">
							...
							<?php 
							$baseurl = base_url();
							if($c_url == $baseurl || $c_url == base_url()."home" || $c_url == base_url()."home/step_2" || $c_url == base_url()."home/step_3" || $c_url == base_url()."home/step_4"){?>										<li class="articles custpadright">
							  	 <span>
