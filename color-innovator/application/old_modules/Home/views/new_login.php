    ...
    <div class="">
		<div class="mid-conttainer">
			...
			<form method="post" action="#" name="login-frm" id="login-frm" >
				<h3>Welcome to Dinoflex's newest digital do-it-yourself method of designing your very own custom color scheme. 
...
The final sample can be saved digitally via email, or can be made into a sample tile, which we can take into production afterwards.</h3>
