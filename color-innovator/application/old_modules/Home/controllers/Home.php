...
class Home extends MX_Controller {	
	...
	public function send_to_email()
	{
	    ...
	    $config['smtp_user']    = 'devdevelopment6@gmail.com';    //Important
	    $config['smtp_pass']    = '6M?KouYNwhYD';  //Important
		...
		$this->email->from('info@dinoflex.com', 'Dinoflex');
		$this->email->to($email_user);
		//$this->email->to(array($email_user, 'llarlee@f12.net', 'specifications@dinoflex.com','devdevelopment6@gmail.com'));
		$this->email->cc('sales@dinoflex.com');
		$this->email->subject('Dinoflex - The Color Innovator - Your Favorite Swatch');

		$email_facebook_icon = '<img src="https://s3.amazonaws.com/dinoflex/facebook-64.png">';
		$email_facebook = '<a href="https://www.facebook.com/pages/Dinoflex/682542678475641" target="_blank">' . $email_facebook_icon . '</a>';
		$email_twitter_icon = '<img src="https://s3.amazonaws.com/dinoflex/twitter-32.png">';
		$email_twitter = '<a href="https://twitter.com/dino_flex" target="_blank">' . $email_twitter_icon . '</a>';
		$email_dino_logo = '<img  style="width:190px;height:77px;" src="'.base_url().'home_assets/images/Dinoflex-logo.jpg" alt="">';
		$subscribe_link = '<a href="http://mad.ly/signups/108095/join" target="_blank"><img src="https://s3.amazonaws.com/dinoflex/subscribe.png"></a>';
		
		$this->email->message('Thank you for using the Dinoflex! Please remember that this swatch has been generated for conceptual, digital use only.' . $request_sample_url_email . '<br/><br/>' . 'Swatch Name: <b>' . $name_swatch . '</b><br/><br/>Your formula for ' . $name_swatch . '<br/><br/>' . $html_email . '<br/>' . $email_image . '<br/><br/>Stay in the loop with Dinoflex news, new product developments, technical information, and more!  Subscribe to our mailing list to receive our quarterly newsletter and special bulletins.<br/><br/>' . $subscribe_link . '&#160;' . $email_facebook . '&#160;' . $email_twitter . '<br/><br/>' . $email_dino_logo . ' V1' );
		$this->email->send();
	}
	public function send_to_email_with_gallery()
	{
       ...
       // print_r($email_info);die;
		...
		//$this->email->to(array($email_user, 'llarlee@f12.net', 'specifications@dinoflex.com','devdevelopment6@gmail.com'));
		$this->email->cc('sales@dinoflex.com');
		$this->email->subject('Dinoflex - Your Favorite Swatch');
		...
		$subscribe_link = '<a href="http://mad.ly/signups/108095/join" target="_blank"><img src="https://s3.amazonaws.com/dinoflex/subscribe.png"></a>';
		$this->email->message('Thank you for using the Dinoflex! Please remember that this swatch has been generated for conceptual, digital use only.' . $request_sample_url_email . '<br/><br/>' . 'Swatch Name: <b>' . $name_swatch . '</b><br/><br/>Your formula for ' . $name_swatch . '<br/><br/>' . $html_email . '<br/>' . $email_image . '<br/><b>Gallery Image</b><br />'.$gallery_image.'<br/><br/>Stay in the loop with Dinoflex news, new product developments, technical information, and more!  Subscribe to our mailing list to receive our quarterly newsletter and special bulletins.<br/><br/>' . $email_dino_logo  );
		$this->email->send();
	}
	public function send_to_email_from_gallery()
	{
		...
		$subscribe_link = '<a href="http://mad.ly/signups/108095/join" target="_blank"><img src="https://s3.amazonaws.com/dinoflex/subscribe.png"></a>';
		$this->email->message('Thank you for using the Dinoflex! Please remember that this swatch has been generated for conceptual, digital use only.' . $request_sample_url_email . '<br/><br/>' . 'Swatch Name: <b>' . $name_swatch . '</b><br/><br/>Your formula for ' . $name_swatch . '<br/><br/>' . $html_email . '<br/>' . $email_image . '<br/>Stay in the loop with Dinoflex news, new product developments, technical information, and more!  Subscribe to our mailing list to receive our quarterly newsletter and special bulletins.<br/><br/>' . $email_dino_logo );
		$this->email->send();
	}
...
echo $dest = imagecreatefromjpeg('/home/dinoflex/public_html/Color_innovator_new/images/1_15_0_0_0_Fine-17_20_130_166_89_Coarse-8_25_40_67_96_Fine-14_10_173_47_52_Fine-26_10_208_159_111_Coarse-25_20_166_74_118_Fine-1569318352741.jpg');
echo $src = imagecreatefromjpeg('/home/dinoflex/public_html/Color_innovator_new/uploads/user_custom_images/18/20200212104941826.JPG');
...
die;
	...
	*/	
	...
	/*	$gallery_image_section = '<div class="col-md-12 " style="height: 555px; width: 100%;">					
		...
		//$this->email->to(array($email_user, 'llarlee@f12.net', 'specifications@dinoflex.com','devdevelopment6@gmail.com'));
		$this->email->cc('sales@dinoflex.com');
		$this->email->subject('Dinoflex - The Color Innovator - Swatch With Gallery');
		...
		$subscribe_link = '<a href="http://mad.ly/signups/108095/join" target="_blank"><img src="https://s3.amazonaws.com/dinoflex/subscribe.png"></a>';
		$this->email->message('Thank you for using the Dinoflex! Please remember that this swatch has been generated for conceptual, digital use only.' . $request_sample_url_email . '<br/><br/>' . 'Swatch Name: <b>' . $name_swatch . '</b><br/><br/>Your formula for ' . $name_swatch . '<br/><br/>' . $html_email . '<br/>' . $email_image . '<br/><b>Gallery Image</b><br />'.$gallery_image.'<br/><br/>'. $gallery_image_section. '<br/><br/>Stay in the loop with Dinoflex news, new product developments, technical information, and more!  Subscribe to our mailing list to receive our quarterly newsletter and special bulletins.<br/><br/>' . $email_dino_logo  );
...
public function image_merge_logo($user_logo_image='',$swatch_name='')
{
  //  header("Content-Type: image/png");
	...
	//$img_name = "http://oneco.ca/~dinoflex/Color_innovator_new/uploads/user_logo_images/15/20200226072029668.png";
	...
	public function send_to_email_with_logo()
	{
		...
		/*	$logo_image_section = '<div style="width:50%; height:50%;"><div style="width:100%;height:100%;background-image:url('.$email_image_src.');background-size:25% 25%;z-index: 100;"><div style="width:100%;height:100%;background-size:25% 25%;position:relative;background-image:url('.$email_image_src.');text-align: center;opacity: 0.6;z-index: -1;"><img src="'.$logo_image.'" style="width:30%;margin:35% auto;z-index:999;"></div></div></div>';*/
			...
			//$this->email->to(array($email_user, 'llarlee@f12.net', 'specifications@dinoflex.com','devdevelopment6@gmail.com'));
			$this->email->cc('sales@dinoflex.com');
			$this->email->subject('Dinoflex - The Color Innovator - Swatch With Logo');
			...
			$subscribe_link = '<a href="http://mad.ly/signups/108095/join" target="_blank"><img src="https://s3.amazonaws.com/dinoflex/subscribe.png"></a>';
			$this->email->message('Thank you for using the Dinoflex Color Innovator! Please remember that this swatch has been generated for conceptual, digital use only.' . $request_sample_url_email . '<br/><br/>' . 'Swatch Name: <b>' . $name_swatch . '</b><br/><br/>Your formula for ' . $name_swatch . '<br/><br/>' . $html_email . '<br/>' . $email_image .'<br/><br/>'.$logo_image_section1.'<br/><br/>'. $logo_image_section. '<br/><br/>Stay in the loop with Dinoflex news, new product developments, technical information, and more!  Subscribe to our mailing list to receive our quarterly newsletter and special bulletins.<br/><br/>' . $subscribe_link . '&#160;' . $email_facebook . '&#160;' . $email_twitter . '<br/><br/>' . $email_dino_logo );
			$this->email->send();
		}
	}
	...
	function add_reg_user(){
		...
		if($flag!=false){
			...
			$this->email->cc('sales@dinoflex.com');
			$this->email->subject('Dinoflex - Registration Details');

			$message = "Dear <b>".$data1['name']."</b> ";
			$message .= "<h5>Welcome to Dinoflex!!</h5>";
	...
	function forgot_password_reset()
	{
		...
		if($flag!=false){
			...
			$this->email->cc('sales@dinoflex.com');
			$this->email->subject('Dinoflex - Password Recover');

			$message = "Dear <b>".$details['name']."</b> ";
			$message .= "<p>Your new login password for <b>Dinoflex </b>account is given below. </p>  ";
	...
	/*function request_sample()
	{
		...
		if($flag!=false){
			...
			$this->email->initialize($config);
			$this->email->from('summit.flooring2019@gmail.com', 'Dinoflex');
			$this->email->to('info@dinoflex.com');
	...
	function request_sample()
	{
		...
		if($flag!=false){
			...
			$this->email->initialize($config);
			$this->email->from('sales@dinoflex.com', 'Color Innovator');
		    //$this->email->to('sales@dinoflex.com');
			//$this->email->to($post_data_array['request_email']);
			$this->email->to(array($post_data_array['request_email'],'llarlee@f12.net'));
			$this->email->cc('sales@dinoflex.com');
