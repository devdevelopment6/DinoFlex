<div class="custheadright hidden-lg hidden-md col-sm-12 col-xs-12">
	<div class="comat">
		<a href="https://dinoflex.com/" target="_blank"><img class="atm_logo" src="<?php echo base_url(); ?>home_assets/images/Dinoflex-logo.jpg"></a>
	...
	<div class="container">
		<div id="cus_foo">
			<div class="submit-flooring">
				<!-- <li>© 2019. Dinoflex recycled rubber innovators. All rights reserved.<br>Complete Convergent Communication provided by <a href="http://theoneco.com/" target="_blank"><span class="yellowcolor">theONEco</span></a></li> -->

					<li>&copy; <?php echo date('Y'); ?>. Dinoflex Recycled Rubber Reimagined. All rights reserved.<br/> Built by theOneCo and Powered by <a href="https://www.ciprcommunications.com/"><span class="yellowcolor">CIPR Communications </span></a></li>

					<!-- <p class="text-center font18">&copy; <?php echo date('Y'); ?>. Dinoflex Recycled Rubber Reimagined. All rights reserved.<br/> Built by the One Co and Powered by <a href="https://www.ciprcommunications.com/"><span class="yellowcolor">CIPR Communications </span></a>
					</p> -->
			</div>
		</div> 	
	</div>
