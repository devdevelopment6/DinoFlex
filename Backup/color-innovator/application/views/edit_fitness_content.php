...
<div class="widget-box ui-sortable-handle" id="widget-box-1">
	...
	<div class="widget-body">
		<div class="widget-main">
			<div id="page-wrapper">
				<form class="form-horizontal" id="add_news" action="<?php echo base_url(); ?>manage_home/update_fitness_content/<?php echo $fitness['id']; ?>" method="post" enctype="multipart/form-data">
					<input type="hidden" name="fitness_id" id="fitness_id" value="<?php echo $fitness['id']; ?>"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input class="col-sm-8" type="text" id="title" name="title" placeholder="Add Title" value="<?php echo $fitness['header_title']; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea rows="8" id="header_content" name="header_content" class="form-control1"><?php echo $fitness['header_content']; ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input class="col-sm-8" type="text" id="section_title" name="section_title" placeholder="Add Title" value="<?php echo $fitness['section_title']; ?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea rows="8" id="section_content" name="section_content" class="form-control1"><?php echo $fitness['section_content']; ?></textarea>
						</div>
					</div>
                ...
                <div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<select class="col-sm-6" name="status" id="status">
								...
								<option <?php if($fitness['status']=="1"){echo "selected";}?> value="1">Enable</option>
								<option <?php if($fitness['status']=="0"){echo "selected";}?> value="0">Disable</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-8 col-sm-offset-2">
							<button type="submit" class="btn-yellow btn" name="update">Update Fitness Content</button>  &nbsp  <a href="<?php echo base_url();?>manage_home/manage_fitness" class="btn-yellow btn" />Cancel</a>
						</div>
					</div>
				</form>
			</div>
	...
	$(document).ready(function(){
		...
		$(".closing_banner").on("click",function(){
			...
			if (result) {
				...
				var id  =   $("#fitness_id").val();
				if(id	!=	'')																																																								 		{
					$.ajax({
						"url":"<?php echo base_url();?>manage_home/delete_fitness_category_banner_image",
						"type":"POST",
						"data":{
							id :id,
							image_id :image_id
