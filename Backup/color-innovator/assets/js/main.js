		  ...
		  temp_count++;
			 ...
			 $("#favourite").click(function () {
					 ...
					 if (name_swatch == "")
					 {
						...
						// $.post("http://dinoflex.com/dinoflex_apps_1/mixomatic/create_session", {img_request_sample: post_img_request_sample});     
				 }
				 var get_src;
		...
		//alert('test');
         ...
         $('#favourite').css('pointer-events','stroke');
          ...
          var saved_swatches_array =[];
            ...
            //$.post("http://dinoflex.com/dinoflex_apps_1/display_floor/index", {src_array: saved_swatches_array}); 
         return;
      });
