...
<script type="text/javascript" src="http://www.nice3aiea.com/js/153987.js" ></script>
	...
	<div class="col-lg-12 response_social">
		<p class="response_social_icon">
			...
			<a href="tel:877-713-1899" class="fa fa-phone" title="Call Us"></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="col-lg-5 col-md-7 col-xl-5 p-3 pb-1 py-0 my-0 float-right d-sm-none d-md-block d-none">
					<p>         
