        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Area Size Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
function getContentTable()
	{
		...
		content_table = $('#content_table').dataTable({
			...
			"aaSorting": [],
			"sAjaxSource": base_url+"area_size/get_area_size",
					"fnDrawCallback": function () {
				$(".delete_area_size").on('click',function(){
					var id=$(this).data('id');
					$.confirm({
						title: 'Confirm!',
						...
						buttons: {
							confirm: function () {
								$.ajax({
									"url": base_url+'Area_size/delete_area_size/'+id,
									"method": 'POST',
									"data":{},
