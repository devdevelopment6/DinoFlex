  ...
  <!--<div class="row"> -->
  	<div class="container"><h1 class="mt-5 grey-txt-b text-center product_head1"><?php echo $contents['header_title'];?></h1></div>
    <div class="container pt-5 product_head2">
      <p class="text-center txt"><?php echo $contents['header_content'];?></p>
    </div>
  <!--</div>-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-12 pt-5">
          <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-12 pr-5 pb-5 float-left"> 
	      ...
	      <div class="custome_product1">
	          <div class="row">
	            ...
	            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4 col-12 pr-5 pb-5 float-right">
      ...
      <!--<div class="btn-group-lg" role="group" aria-label="Third group">
		...
		<div class="text-center bighover d-block mx-auto req_btn_width" role="group" aria-label="Third group"> 
			<a href="<?php echo $contents['button_link']; ?>" class=" buttons">
				...
				<button class="draw meet button-big show_cursor">Request a Sample</button>
			</a>
...
<script type="text/javascript">
  $("#indoor_link").on("mouseover", function () {
    //stuff to do on mouseover
    //alert('test');
   // $("#Main svg").css("fill",'#556C11');
  });
</script>
