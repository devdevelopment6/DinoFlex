      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  id="add_content_frm" name="add_content_frm" method="post" action="<?php echo base_url().'cms_products/update_sliders/'.$content['id']; ?>" enctype="multipart/form-data">
              ...
              <div class="box-body">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-4 col-xs-4">
								...
								<?php 	
                                    ...
                                    ?>
                                    <div class="col-md-2">
                                       <img class="slider_image" src="<?php echo base_url();?>uploads/product_page_sliders/<?=$display; ?>" width="100px" height="100px" />
                                    </div>
                                    <?php 
                                            }
                                        }
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							<div class="col-md-3 col-sm-3 col-xs-3">	
								 <label for="title_2">Select Product</label>
							</div>
							<div class="col-md-4 col-sm-4 col-xs-4">
                                 <select name="product" id="product" class="form-control">
                                    <option value=""> --- Select Product --- </option>
                                    <?php foreach($products as $product)  { ?>
                                        <option value="<?php echo $product['id']; ?>" <?php echo ($content['product_id'] == $product['id'])?'selected':'';?>> <?php echo $product['product_name']; ?> </option>
                                    <?php } ?>
                                </select>
							</div>
						</div>
