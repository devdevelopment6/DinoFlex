        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Application Category Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
function getContentTable()
	{
		...
		content_table = $('#content_table').dataTable({
			...
			"aaSorting": [],
			"sAjaxSource": base_url+"application_products/get_application_products",
					"fnDrawCallback": function () {
				$(".delete_application_products").on('click',function(){
					var id=$(this).data('id');
					$.confirm({
						title: 'Confirm!',
						...
						buttons: {
							confirm: function () {
								$.ajax({
									"url": base_url+'/application_products/delete_application_product/'+id,
									"method": 'POST',
									"data":{},
