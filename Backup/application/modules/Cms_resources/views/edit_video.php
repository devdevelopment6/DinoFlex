			...
			<div class="box-body">
				...
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="col-md-2">
								<img class="slider_image" src="<?php echo base_url();?>uploads/home_slide/thumbs/<?php echo $videos['banner_image'] ?>" width="100px" height="100px">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="col-md-2">
								<img class="slider_image" src="<?php echo base_url();?>uploads/home_slide/thumbs/<?php echo $videos['image'] ?>" width="100px" height="100px">
							</div>
						</div>
					</div>
				</div>
