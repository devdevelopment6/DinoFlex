      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  id="add_application_frm" name="add_application_frm" method="post" action="<?php echo base_url().'cms_products/save_application'; ?>" enctype="multipart/form-data">
			 ...
			 <div class="box-footer">
				 <div class="col-md-12 col-sm-12 col-xs-12">
                	<input type="submit" class="btn btn-primary submit_button" value="Add Application">
