      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  id="add_content_frm" name="add_content_frm" method="post" action="<?php echo base_url().'admin_color_finder/update_sliders/'.$content['id']; ?>" enctype="multipart/form-data">
              ...
              <div class="box-body">
               ...
               <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
                      ...
                      ?>
                      <div class="col-md-2">
                         <img class="slider_image" src="<?php echo base_url();?>uploads/color_finder_sliders/<?=$display; ?>" width="100px" height="100px" />
                      </div>
                      <?php 
                              }
                          }
