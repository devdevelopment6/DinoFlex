<div class="row">
    <div class="container-fluid bg-contact-top-content" style="background: url(<?php echo base_url();?>/uploads/blog/<?php echo $blog['banner_image'];?>) no-repeat;repeat;background-size: cover;
    padding-top: 8%;
    padding-bottom: 8%;">
      <div class="row">
        <div class="container">
