...
class Cms_resources extends MX_Controller
{
	...
	function create()
	{
		...
		$table = "Cms_resources_content";
		if($_FILES['banner_image']['name']!='')
		{
			$thumb['height']=200;
			$thumb['width']=200;
			$image_data=$this->common_model->upload('banner_image','home_image/',$allowd="jpg|jpeg|png",$thumb,'');
		...
		if($_FILES['section_image_1']['name']!='')
		{
			$thumb['height']=200;
			$thumb['width']=200;
			$image_data=$this->common_model->upload('section_image_1','home_image/',$allowd="jpg|jpeg|png",$thumb,'');
		...
		if($_FILES['section_image_2']['name']!='')
		{
			$thumb['height']=200;
			$thumb['width']=200;
			$image_data=$this->common_model->upload('section_image_2','home_image/',$allowd="jpg|jpeg|png",$thumb,'');
		...
		if($_FILES['banner_image_2']['name']!='')
		{
			$thumb['height']=200;
			$thumb['width']=200;
			$image_data=$this->common_model->upload('banner_image_2','home_image/',$allowd="jpg|jpeg|png",$thumb,'');
		...
		*/
		...
		foreach($rResult->result_array() as $aRow) {
			...
			$row[] = '<div class="action-buttons">				
						<a class="btn btn-warning btn-xs" href="'.base_url().'Cms_resources/edit/'.$aRow['id'].'">
	...
	function get_home_slide()
	{
		...
		*/
		...
		foreach($rResult->result_array() as $aRow) {
			...
			$row[] = '<div class="action-buttons">				
						<a class="btn btn-warning btn-xs" href="'.base_url().'Cms_resources/edit_slide/'.$aRow['id'].'">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>
	...
	function upload_video()
	{
		...
		if($flag != false)
		{
			...
			redirect("Cms_resources/view_videos");
		}
		else
		{
			$this->set_error("ERROR! Unknown Error!");
	...
	function get_home_videos()
	{
		...
		*/
		...
		foreach($rResult->result_array() as $aRow) {
			...
			$row[] = '<div class="action-buttons">				
						<a class="btn btn-warning btn-xs" href="'.base_url().'Cms_resources/edit_video/'.$aRow['id'].'">
							<i class="ace-icon fa fa-pencil bigger-130"></i>
						</a>
