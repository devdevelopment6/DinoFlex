        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">View Community</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
function getContentTable()
	{
		...
		content_table = $('#content_table').dataTable({
			...
			"aaSorting": [],
			"sAjaxSource": base_url+"Cms_about/get_community",
					"fnDrawCallback": function () {
				$(".delete_commu").on('click',function(){
					var id=$(this).data('id');
					$.confirm({
						title: 'Confirm!',
						...
						buttons: {
							confirm: function () {
								$.ajax({
									"url": base_url+'Cms_about/delete_community/'+id,
									"method": 'POST',
									"data":{},
