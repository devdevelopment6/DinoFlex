		...
		<div class=" col-sm-12 text-center product_category_main">
			<div class="col-md-3 product_category_request_quote">
				<a class="sample_request request_quote_btn">
					<div class="new_browse_btn_product_category"><img src="<?php echo base_url();?>homepage_assests/new_images_1/dinoflex-button-icon.svg" alt="dinoflex-button-icon" class="top_learn_more_btn_category"><span>Request Quote</span></div>
				</a>
			</div>
		 </div>
	  </div>
