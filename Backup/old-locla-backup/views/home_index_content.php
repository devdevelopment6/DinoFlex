		...
		<div class="">
        	<div class="col-md-4 float_right about_content_2">         
                ...
                <div class="row">
                    ...
                    <p class="text-right col-md-9 col-sm-10 content_about"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?php echo $home['top_content']; ?></p>
                    
                </div>
                <div class="row main_home_content_page">
                <div class="col-md-6 col-sm-1"></div>
                    <div class="col-md-4 col-sm-9 btn_skewx text-center" >
                        <a href="<?php echo base_url();?>front_end"><div class="text-skewx"><span>Back</span>
                                    </div>
                        </a>
                    </div>
                </div>
