	...
	<header>
		<div class="container-fluid">
			...
			<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 header_right_menu">
				<a href="http://oneco.ca/~dinoflex/New_color_innovator/home"><img class="img-responsive" src="<?php echo base_url(); ?>home_assets/img/logo.png" style="width:100px;" ></a>
...
<div class="container" >
	<div class="col-md-12 col-xs-12 col-lg-12 col-sm-12" >
		<div class="form-group">
			...
			<label>Email : <a href="mailto:info@dinoflex.com">info@dinoflex.com</a></label>
		</div>
