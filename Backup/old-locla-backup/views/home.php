	...
	<header>
		<div class="container-fluid">
			...
			<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 header_right_menu">
				<a href="http://oneco.ca/~dinoflex/New_color_innovator/home"><img class="img-responsive" src="<?php echo base_url(); ?>home_assets/img/Dinoflex-logo.jpg" style="width:100px;" ></a>
