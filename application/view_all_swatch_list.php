                        ...
                        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 col-xl-12 pt-3 btn-group">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu sort_price" aria-labelledby="dropdownMenuButton">
                                  <a class="dropdown-item txt show_cursor" id="low">Low to High (L1 to L4)</a>
                                  <a class="dropdown-item txt show_cursor" id="high">High to Low (L4 to L1)</a>
                                </div>
                              </div>
                          <?php } ?>
                        </div>
                      ...
                      ?>
                              ...
                              <div class="row pb-5">
                                ...
                                <?php foreach($get_swatch_colors as $gallery_image) {
                                    ...
                                    $caption .= 'Price Level: '.$gallery_image['price_level'];
                                ?>
