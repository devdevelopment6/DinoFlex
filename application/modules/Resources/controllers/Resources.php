...
class Resources extends MX_Controller
{
	...
	function index()
	{
		...
		$this->data['brochures'] = $this->common_model->get_by_condition('products_downloads_documents',array('document_type'=> 'Brochure','status'=>1), array('resource_position'=> 'Asc'));
	...
	function load_view($view = "")
	{
		...
		$this->data['meta_content'] = 'Our Resources Page is the place to find links and PDF’s for Technical Specifications, Warranty Information, Installation Guidelines, as well as Cleaning and Maintenance. Can’t find what you’re looking for? Try downloading some of our helpful product brochures.';
