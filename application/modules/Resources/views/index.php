		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
				<div class="carousel-item active">
					<a href="https://dinoflex.concora.com/" target="_blank" title="Dinoflex Launch">
           <!--  <img class="d-block w-100" src="<?php echo base_url(); ?>/uploads/resources_banner_images/Dinoflex-Banner-Web.jpg" alt="Dinoflex Launch" > -->

           <img class="d-block w-100" src="<?php echo base_url(); ?>uploads/home_slide/2021022408553820.png" alt="Dinoflex Launch" >
          </a>
				</div>
			</div>
		</div>
