      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form  id="add_content_frm" name="add_content_frm" method="post" action="<?php echo base_url().'cms_product_category/save_product_category_content'; ?>" enctype="multipart/form-data">
              <div class="box-body">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="header_content" id="header_content" class="form-control" placeholder="Description" required></textarea>
							</div>
						</div>
					</div>
				</div>
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="product_content" id="product_content" class="form-control" placeholder="Description"></textarea>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="custom_design_content" id="custom_design_content" class="form-control"></textarea>
							</div>
						</div>
					</div>
				</div>
             	...
             	<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="custom_logo_colors_content" id="custom_logo_colors_content" class="form-control"></textarea>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="custom_products_content" id="custom_products_content" class="form-control"></textarea>
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-8 col-sm-8 col-xs-8">
								<textarea name="footer_description" id="footer_description" class="form-control" placeholder="Description"></textarea>
							</div>
						</div>
					</div>
				</div>
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-4 col-sm-4 col-xs-4">
                                <input type="text" name="button_link" id="button_link" value="" class="form-control" placeholder="Button Link"/>
							</div>
						</div>
					</div>
				</div>
