...
<section class="content">
      <div class="row">
		...
		<form role="form" method="post" id="home_content" action="<?php echo base_url(); ?>Cms_blog/create" name="home_content" enctype="multipart/form-data">
			<div class="box-body">
				...
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div class="form-group">
						...
						<input type="text" id="browsertitle" name = "browsertitle" value="" placeholder="BrowserTitle" class="form-control" />
					</div>
				</div>
			 ...
			 <div class="box-footer">
				 <div class="col-md-5 col-sm-5 col-xs-5">
					<input type="submit" class="btn btn-success btn-sm" name="Add Home Content" id="Add Home Content" value="Add Bolgs">
