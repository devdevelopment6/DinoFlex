...
class Manage_applications extends CI_Controller {
	...
	function edit_application_detail($id='')
	{
		...
		$this->data['sub_categories']    = $this->common_model->get_by_condition('application_sub_categories',array('application_category_id'=>$this->data['application_details']['category_id']));
		$view = "edit_application_detail";
		$this->load_view($view);
	}
	...
	function get_sub_categories(){
		...
		$flag=$this->common_model->get_by_condition("application_sub_categories",array('application_category_id'=>$cat_id));
		if($flag!=false){
			foreach($flag as $one){
