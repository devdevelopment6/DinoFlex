			...
			<div class="box-body">
				...
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div class="form-group">
						...
						<textarea type="text" name="meta_description" id="meta_description" class="form-control" /><?php echo $home['meta_description']; ?></textarea>
					</div>
				</div>
				...
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div class="form-group">
						...
						<div class="col-md-12">
							<div class="col-md-2">
								<img class="slider_image" src="<?php echo base_url();?>uploads/home_image/<?php echo $home['section_img1'] ?>" width="100px" height="100px">
							</div>
						</div>
					</div>
				</div>
