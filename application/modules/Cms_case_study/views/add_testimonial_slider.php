	...
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				...
				<form role="form" method="post" id="custom-form" action="<?php echo base_url(); ?>cms_case_study/create_testimonial_slider" name="add_category_slider" enctype="multipart/form-data">
					...
					<div class="box-footer">
						<div class="col-md-5 col-sm-5 col-xs-5">
							<input type="submit" class="btn btn-success btn-sm" name="add_slider" id="add_slider" value="Add Testimonial Slider">
