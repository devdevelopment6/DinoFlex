        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Application Sub Category Listing</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
function getContentTable()
	{
		...
		content_table = $('#content_table').dataTable({
			...
			"aaSorting": [],
			"sAjaxSource": base_url+"application_sub_category/get_application_sub_category",
					"fnDrawCallback": function () {
				$(".delete_application_sub_category").on('click',function(){
					var id=$(this).data('id');
					$.confirm({
						title: 'Confirm!',
						...
						buttons: {
							confirm: function () {
								$.ajax({
									"url": base_url+'/application_sub_category/delete_application_sub_category/'+id,
									"method": 'POST',
									"data":{},
