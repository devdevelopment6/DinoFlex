...
class Cms_products extends MX_Controller {
	...
	function get_product_content()
	{
		...
		$data['header_sub_title']	=	$this->input->post('header_sub_title');
		...
		$data['features_1']	=	$this->input->post('features_1');
		$data['applications_1']	=	$this->input->post('applications_1');
		...
		if($this->input->post('order_index') !=''){
		    $data['order_index']	=	$this->input->post('order_index');	
		}
		else{
		  	$result= $this->db->query("SELECT MAX(order_index) AS maximum FROM products");

        $row = $result->row(); 
       
        $data['order_index'] = $row->maximum +1;  
		}
		...
		$flag=$this->common_model->insert_data('products',$data);
			if($flag!= '')
			{
				...
				if($_FILES['video_image_3']['name']!=''){
					...
					if(isset($_FILES['colors']['name']) && $_FILES['colors']['name'] != "" && $_FILES['colors']['name'][0] != '')
					{
						$files = $_FILES['colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('colors', "products_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['metro_colors']['name']) && $_FILES['metro_colors']['name'] != "" && $_FILES['metro_colors']['name'][0] != '')
					{
						$files = $_FILES['metro_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('metro_colors', "products_metro_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['standard_colors']['name']) && $_FILES['standard_colors']['name'] != "" && $_FILES['standard_colors']['name'][0] != '')
					{
						$files = $_FILES['standard_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('standard_colors', "products_standard_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['stone_colors']['name']) && $_FILES['stone_colors']['name'] != "" && $_FILES['stone_colors']['name'][0] != '')
					{
						$files = $_FILES['stone_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('stone_colors', "products_stone_line_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['elite_colors']['name']) && $_FILES['elite_colors']['name'] != "" && $_FILES['elite_colors']['name'][0] != '')
					{
						$files = $_FILES['elite_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('elite_colors', "products_elite_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['decore_colors']['name']) && $_FILES['decore_colors']['name'] != "" && $_FILES['decore_colors']['name'][0] != '')
					{
						$files = $_FILES['decore_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('decore_colors', "products_decor_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['granite_colors']['name']) && $_FILES['granite_colors']['name'] != "" && $_FILES['granite_colors']['name'][0] != '')
					{
						$files = $_FILES['granite_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('granite_colors', "products_granite_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['combo_colors']['name']) && $_FILES['combo_colors']['name'] != "" && $_FILES['combo_colors']['name'][0] != '')
					{
						$files = $_FILES['combo_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('combo_colors', "products_combo_colors/".$flag, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE));
					...
					foreach($download_docs as $key=>$value){
					...
					foreach($resources_docs as $key=>$value){
						if($this->input->post('resource_title_'.$value) != '' && $_FILES['resource_file_'.$value]['name']!='' && $this->input->post('resource_type_'.$value) != '') 
						{
							...
							$resource_type = $this->input->post('resource_type_'.$value);
							 ...
							 $this->db->select('max(resource_position) as max_position');
						     $this->db->from('products_resources_documents');
						     $this->db->where('resource_type',$resource_type);
						     
						     $max_val_data = $this->db->get()->result_array();
						     
						     if($max_val_data != false){
							     $max_val = ($max_val_data[0]['max_position'] + 1);
						     }
						     else{
						         $max_val = 1;
						     }
	...
	function edit_product($id="")
	{
		if($id!='')
		{
			...
			$this->data['evo50'] = $this->common_model->get_by_condition('products_evo50_colors',array('product_id'=>$id));
			$this->data['evo60'] = $this->common_model->get_by_condition('products_evo60_colors',array('product_id'=>$id));
			$this->data['evo70'] = $this->common_model->get_by_condition('products_evo70_colors',array('product_id'=>$id));
			$this->data['evo80'] = $this->common_model->get_by_condition('products_evo80_colors',array('product_id'=>$id));
			$this->data['evo90'] = $this->common_model->get_by_condition('products_evo90_colors',array('product_id'=>$id));
	...
	{	
		...
		$filter=array('id'=>$id);
				...
				if(isset($_FILES['colors']['name']) && $_FILES['colors']['name'] != "" && $_FILES['colors']['name'][0] != '')
					{
						$files = $_FILES['colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('colors', "products_colors/".$id, $allowd="jpg|jpeg|png|svg|gif", array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								//array('width'=>300,'height'=>200,'maintain_ratio'=>FALSE),
								if($data2 != false)
								{
									$insert_img = array(
										'product_id'		=>	$id,
					...
					if(isset($_FILES['metro_colors']['name']) && $_FILES['metro_colors']['name'] != "" && $_FILES['metro_colors']['name'][0] != '')
					{
						$files = $_FILES['metro_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('metro_colors', "products_metro_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['standard_colors']['name']) && $_FILES['standard_colors']['name'] != "" && $_FILES['standard_colors']['name'][0] != '')
					{
						$files = $_FILES['standard_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('standard_colors', "products_standard_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['stone_colors']['name']) && $_FILES['stone_colors']['name'] != "" && $_FILES['stone_colors']['name'][0] != '')
					{
						$files = $_FILES['stone_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('stone_colors', "products_stone_line_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['elite_colors']['name']) && $_FILES['elite_colors']['name'] != "" && $_FILES['elite_colors']['name'][0] != '')
					{
						$files = $_FILES['elite_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('elite_colors', "products_elite_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['decore_colors']['name']) && $_FILES['decore_colors']['name'] != "" && $_FILES['decore_colors']['name'][0] != '')
					{
						$files = $_FILES['decore_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('decore_colors', "products_decor_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['granite_colors']['name']) && $_FILES['granite_colors']['name'] != "" && $_FILES['granite_colors']['name'][0] != '')
					{
						$files = $_FILES['granite_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('granite_colors', "products_granite_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['combo_colors']['name']) && $_FILES['combo_colors']['name'] != "" && $_FILES['combo_colors']['name'][0] != '')
					{
						$files = $_FILES['combo_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload_with_orgname('combo_colors', "products_combo_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['gallery']['name']) && $_FILES['gallery']['name'] != "" && $_FILES['gallery']['name'][0] != '')
					{
						$files = $_FILES['gallery'];
							for($i=0;$i<count($files['name']);$i++)
							{
								...
								$data2 = $this->common_model->upload('gallery', "products_gallery/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
					...
					if(isset($_FILES['evo50_colors']['name']) && $_FILES['evo50_colors']['name'] != "" && $_FILES['evo50_colors']['name'][0] != '')
					{
						$files = $_FILES['evo50_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								$data1= array();
								$_FILES['evo50_colors']['name']      = $files['name'][$i];
								$_FILES['evo50_colors']['type']      = $files['type'][$i];
								$_FILES['evo50_colors']['tmp_name']  = $files['tmp_name'][$i];
								$_FILES['evo50_colors']['error']     = $files['error'][$i];
								$_FILES['evo50_colors']['size']      = $files['size'][$i];
		
								$data2 = $this->common_model->upload_with_orgname('evo50_colors', "products_evo50_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								...
								if($data2 != false)
								{
									...
									$flag1 = $this->common_model->insert_data('products_evo50_colors', $insert_img);
								}
							}
					}
					
					if(isset($_FILES['evo60_colors']['name']) && $_FILES['evo60_colors']['name'] != "" && $_FILES['evo60_colors']['name'][0] != '')
					{
						$files = $_FILES['evo60_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								$data1= array();
								$_FILES['evo60_colors']['name']      = $files['name'][$i];
								$_FILES['evo60_colors']['type']      = $files['type'][$i];
								$_FILES['evo60_colors']['tmp_name']  = $files['tmp_name'][$i];
								$_FILES['evo60_colors']['error']     = $files['error'][$i];
								$_FILES['evo60_colors']['size']      = $files['size'][$i];
		
								$data2 = $this->common_model->upload_with_orgname('evo60_colors', "products_evo60_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								...
								if($data2 != false)
								{
									...
									$flag1 = $this->common_model->insert_data('products_evo60_colors', $insert_img);
								}
							}
					}
					
					if(isset($_FILES['evo70_colors']['name']) && $_FILES['evo70_colors']['name'] != "" && $_FILES['evo70_colors']['name'][0] != '')
					{
						$files = $_FILES['evo70_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								$data1= array();
								$_FILES['evo70_colors']['name']      = $files['name'][$i];
								$_FILES['evo70_colors']['type']      = $files['type'][$i];
								$_FILES['evo70_colors']['tmp_name']  = $files['tmp_name'][$i];
								$_FILES['evo70_colors']['error']     = $files['error'][$i];
								$_FILES['evo70_colors']['size']      = $files['size'][$i];
		
								$data2 = $this->common_model->upload_with_orgname('evo70_colors', "products_evo70_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								...
								if($data2 != false)
								{
									...
									$flag1 = $this->common_model->insert_data('products_evo70_colors', $insert_img);
								}
							}
					}
					
					if(isset($_FILES['evo80_colors']['name']) && $_FILES['evo80_colors']['name'] != "" && $_FILES['evo80_colors']['name'][0] != '')
					{
						$files = $_FILES['evo80_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								$data1= array();
								$_FILES['evo80_colors']['name']      = $files['name'][$i];
								$_FILES['evo80_colors']['type']      = $files['type'][$i];
								$_FILES['evo80_colors']['tmp_name']  = $files['tmp_name'][$i];
								$_FILES['evo80_colors']['error']     = $files['error'][$i];
								$_FILES['evo80_colors']['size']      = $files['size'][$i];
		
								$data2 = $this->common_model->upload_with_orgname('evo80_colors', "products_evo80_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								...
								if($data2 != false)
								{
									...
									$flag1 = $this->common_model->insert_data('products_evo80_colors', $insert_img);
								}
							}
					}
					
					if(isset($_FILES['evo90_colors']['name']) && $_FILES['evo90_colors']['name'] != "" && $_FILES['evo90_colors']['name'][0] != '')
					{
						$files = $_FILES['evo90_colors'];
							for($i=0;$i<count($files['name']);$i++)
							{
								$data1= array();
								$_FILES['evo90_colors']['name']      = $files['name'][$i];
								$_FILES['evo90_colors']['type']      = $files['type'][$i];
								$_FILES['evo90_colors']['tmp_name']  = $files['tmp_name'][$i];
								$_FILES['evo90_colors']['error']     = $files['error'][$i];
								$_FILES['evo90_colors']['size']      = $files['size'][$i];
		
								$data2 = $this->common_model->upload_with_orgname('evo90_colors', "products_evo90_colors/".$id, $allowd="jpg|jpeg|png|svg|gif",array('width'=>200,'height'=>150,'maintain_ratio'=>FALSE),array('width'=>1000,'height'=>900,'maintain_ratio'=>FALSE));
								...
								if($data2 != false)
								{
									...
									$flag1 = $this->common_model->insert_data('products_evo90_colors', $insert_img);
								}
							}
					}
			...
			//print_r(count($old_resource_documents));die;
				...
				if($old_resource_documents  != false)
				{
					foreach($resources_docs as $key =>$value){
							...
							$resource_type = $this->input->post('resource_type_'.$value);
							 ...
							 //  print_r(count($resources_docs));die;
						  // print_r($key);die;
						 
						   
						if( count($old_resource_documents) > $key){
						   	$resource_position = $old_resource_documents[$key]['resource_position'];
						 }
						 else{
						      $this->db->select('max(resource_position) as max_position');
						     $this->db->from('products_resources_documents');
						     ...
						     if($max_val_data != false){
							     $resource_position = ($max_val_data[0]['max_position'] + 1);
						     }
					...
					foreach($resources_docs as $key=>$value){
						...
						/*	$max_val = $this->db->query('select max(resource_position) from products_resources_documents where resource_type = '.$resource_type); */
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					...
					if($data['video_image_1']!='' && file_exists(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_1']) && (!is_dir(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_1'])))
					{
						unlink(FCPATH."uploads/product_video_images/".$id.'/'.$data['video_image_1']);
					}

					if($data['video_image_2']!='' && file_exists(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_2']) && (!is_dir(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_2'])))
					{
						unlink(FCPATH."uploads/product_video_images/".$id.'/'.$data['video_image_2']);
					}

					if($data['video_image_3']!='' && file_exists(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_3']) && (!is_dir(FCPATH.'uploads/product_video_images/'.$id.'/'.$data['video_image_3'])))
					{
						unlink(FCPATH."uploads/product_video_images/".$id.'/'.$data['video_image_3']);
					}

					if($data['product_list_banner']!='' && file_exists(FCPATH.'uploads/product_list_banner/'.$data['product_list_banner']) && file_exists(FCPATH.'uploads/product_list_banner/thumbs/'.$data['product_list_banner']) && (!is_dir(FCPATH.'uploads/product_list_banner/'.$data['product_list_banner'])) && (!is_dir(FCPATH.'uploads/product_list_banner/thumbs/'.$old_data['product_list_banner'])) && (!is_dir(FCPATH.'uploads/product_list_banner/thumbs1/'.$data['product_list_banner'])) )
					{	
						unlink(FCPATH.'uploads/product_list_banner/thumbs1/'.$data['product_list_banner']);
						unlink(FCPATH.'uploads/product_list_banner/thumbs/'.$data['product_list_banner']);
						unlink(FCPATH.'uploads/product_list_banner/'.$data['product_list_banner']);
					}

					$get_colors = $this->common_model->get_by_condition('products_colors',array('product_id'=>$id));
					if($get_colors != false)
					{
						foreach($get_colors as $data)
						{
							...
							$this->common_model->delete_data('products_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_metro_colors = $this->common_model->get_by_condition('products_metro_colors',array('product_id'=>$id));
					if($get_metro_colors != false)
					{
						foreach($get_metro_colors as $data)
						{
							...
							$this->common_model->delete_data('products_metro_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_std_colors = $this->common_model->get_by_condition('products_standard_colors',array('product_id'=>$id));
					if($get_std_colors != false)
					{
						foreach($get_std_colors as $data)
						{
							...
							$this->common_model->delete_data('products_standard_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_stone_colors = $this->common_model->get_by_condition('products_stone_line_colors',array('product_id'=>$id));
					if($get_stone_colors != false)
					{
						foreach($get_stone_colors as $data)
						{
							...
							$this->common_model->delete_data('products_stone_line_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_elite_colors = $this->common_model->get_by_condition('products_elite_colors',array('product_id'=>$id));
					if($get_elite_colors != false)
					{
						foreach($get_elite_colors as $data)
						{
							...
							$this->common_model->delete_data('products_elite_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_decore_colors = $this->common_model->get_by_condition('products_decor_colors',array('product_id'=>$id));
					if($get_decore_colors != false)
					{
						foreach($get_decore_colors as $data)
						{
							...
							$this->common_model->delete_data('products_decor_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_granite_colors = $this->common_model->get_by_condition('products_granite_colors',array('product_id'=>$id));
					if($get_granite_colors != false)
					{
						foreach($get_granite_colors as $data)
						{
							...
							$this->common_model->delete_data('products_granite_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_combo_colors = $this->common_model->get_by_condition('products_combo_colors',array('product_id'=>$id));
					if($get_combo_colors != false)
					{
						foreach($get_combo_colors as $data)
						{
							...
							$this->common_model->delete_data('products_combo_colors',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}

					$get_gallery_colors = $this->common_model->get_by_condition('products_gallery',array('product_id'=>$id));
					if($get_gallery_colors != false)
					{
						foreach($get_gallery_colors as $data)
						{
							...
							$this->common_model->delete_data('products_gallery',array("id"=>$data['id'],"product_id"=>$data['product_id']));
						}
					}
	...
	function delete_evo50_image()
	{
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					if($data['image_name']!='' && file_exists(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/'.$data['image_name']) && file_exists(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name']) && (!is_dir(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/'.$data['image_name'])) && (!is_dir(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name'])) )
					{	
						unlink(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/thumbs/'.$data['image_name']);
						unlink(FCPATH.'uploads/products_evo50_colors/'.$data['product_id'].'/'.$data['image_name']);
					}
					echo true;
				}
				else
	...
	function delete_evo60_image()
	{
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					if($data['image_name']!='' && file_exists(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/'.$data['image_name']) && file_exists(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name']) && (!is_dir(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/'.$data['image_name'])) && (!is_dir(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name'])) )
					{	
						unlink(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/thumbs/'.$data['image_name']);
						unlink(FCPATH.'uploads/products_evo60_colors/'.$data['product_id'].'/'.$data['image_name']);
					}
					echo true;
				}
				else
	...
	function delete_evo70_image()
	{
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					if($data['image_name']!='' && file_exists(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/'.$data['image_name']) && file_exists(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name']) && (!is_dir(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/'.$data['image_name'])) && (!is_dir(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name'])) )
					{	
						unlink(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/thumbs/'.$data['image_name']);
						unlink(FCPATH.'uploads/products_evo70_colors/'.$data['product_id'].'/'.$data['image_name']);
					}
					echo true;
				}
				else
	...
	function delete_evo80_image()
	{
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					if($data['image_name']!='' && file_exists(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/'.$data['image_name']) && file_exists(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name']) && (!is_dir(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/'.$data['image_name'])) && (!is_dir(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name'])) )
					{	
						unlink(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/thumbs/'.$data['image_name']);
						unlink(FCPATH.'uploads/products_evo80_colors/'.$data['product_id'].'/'.$data['image_name']);
					}
					echo true;
				}
				else
	...
	function delete_evo90_image()
	{
		...
		if ($id != "")
		{
			...
			if ($data != false) {
				...
				if ($flag != false)
				{
					if($data['image_name']!='' && file_exists(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/'.$data['image_name']) && file_exists(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name']) && (!is_dir(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/'.$data['image_name'])) && (!is_dir(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/'.'thumbs/'.$data['image_name'])) )
					{	
						unlink(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/thumbs/'.$data['image_name']);
						unlink(FCPATH.'uploads/products_evo90_colors/'.$data['product_id'].'/'.$data['image_name']);
					}
					echo true;
				}
				else
