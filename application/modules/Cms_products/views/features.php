            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a href="<?php echo base_url();?>cms_products/add_feature" class="btn btn-primary col-md-2 col-sm-6 col-xs-12" style="float: left;">Add Feature</a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function getTable()
    {
        table = $('#content').dataTable({
            ...
            "aaSorting": [[ 0, "desc" ]],
            "sAjaxSource": "<?php echo base_url(); ?>cms_products/get_features",
